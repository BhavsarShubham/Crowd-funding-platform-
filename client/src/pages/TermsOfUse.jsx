        ...
        <>
            ...
            <div className='lg:px-24 px-4 py-8' id='8'>
                ...
                <ol className="pt-8">
                    ...
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Secure Payment Processing: </span>Block Fund takes security seriously and uses encryption and other security measures to protect payment  However, you are responsible for safeguarding your payment information, including card details and digital wallet keys. Block Fund is not liable for unauthorized transactions resulting from your failure to maintain proper security.</li>
